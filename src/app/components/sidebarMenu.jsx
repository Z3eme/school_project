...
function SidebarMenu() {
  ...
  return (
    <div className="fixed left-0 top-[4rem] bottom-0 w-[20rem]">
      ...
      <div
        className={`${isMenuVisible ? "fixed left-0 top-[4rem] bottom-0 bg-[#f5f5f5] p-4 border w-[20rem] ease-in-out duration-[750ms] z-0" : "fixed left-[-500px] top-[4rem] bottom-0 bg-[#f5f5f5] p-4 border w-[20rem] ease-in-out duration-[750ms] z-0"}`}
      >
        <svg
        onClick={toggleMenuVisibility}
        xmlns="http://www.w3.org/2000/svg"
